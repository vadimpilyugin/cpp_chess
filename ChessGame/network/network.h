...
namespace Network {
    ...
    */
    ...
    public:
        CannotSendException(const std::string _msg): Exception(_msg) {}
    };
    // Нет готовых сообщений, чтобы принять. Нужен в случае неблокирующего приема
    class NoMessagesException: public Exception::Exception {
    public:
        NoMessagesException(const std::string _msg): Exception(_msg) {}
    };
    /*
